...
Usage:
    python compile_data.py [workbook.xlsx] [output.js]
...
WB_PATH = sys.argv[1] if len(sys.argv) > 1 else "genre_chord_bank_v9.xlsx"
OUT_PATH = sys.argv[2] if len(sys.argv) > 2 else "song_data.js"
